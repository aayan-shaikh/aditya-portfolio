...
// Configuration
const sourceDir = path.join(__dirname, 'public', 'portfolio', 'retouching');
const outputDir = path.join(__dirname, 'public', 'portfolio', 'retouching', 'images-avif');
...
async function convertToAvif(inputPath, outputPath) {
    try {
        await sharp(inputPath)
            .avif({ quality: 60 }) // Adjust quality (0-100, default 50)
            .toFile(outputPath);
